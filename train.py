...
class Instructor:
    def __init__(self, opt):
        ...
        self.train = trainset
        if opt.dan == True:
            trainset = make_dependency_aware(trainset, opt.dataset)
            testset = make_dependency_aware(testset, opt.dataset)
...
if __name__ == '__main__':
    ...
    dataset_files = {
        ...
        'restaurant': {
            ...
            'test': 'data/datasets/Restaurants_Test_Gold.xml.seg'
        },
        'laptop': {
            'train': 'data/datasets/Laptops_Train.xml.seg',
            'test': 'data/datasets/Laptops_Test_Gold.xml.seg'
        }
    }
    input_colses = {
